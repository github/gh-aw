...
Triggers other workflows in the same repository using GitHub's `workflow_dispatch` event. This enables agent coordination and task delegation patterns, such as campaign workflows that coordinate multiple worker workflows.
