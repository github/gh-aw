---
title: Custom Agent support for Agentic Workflows
...
In this guide, we show you how to install and use the custom `agentic-workflows` agent to create, update, import, and debug agentic workflows in your repository.

## Installing the Custom Agent for Agentic Workflows
...
2. **Install the Custom Agent for Agentic Workflows into your repository**. 
...
## Using the Custom Agent for Agentic Workflows
