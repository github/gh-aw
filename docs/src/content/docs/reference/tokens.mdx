...
This page provides a comprehensive reference for Authentication options in GitHub Agentic Workflows, including:
...
- Using GitHub Apps as an alternative authorization mechanism
...
## Using tokens from GitHub Apps instead of secrets

For enhanced security with short-lived tokens, you may configure GitHub Apps instead. 
