...
[Run #26515287616](https://github.com/github/gh-aw/actions/runs/26515287616), logged on May 27, ran for 10.7 minutes and processed 12.2 million AI Credits. Those numbers matter because they reflect how much context the analyzer actually reads — audit logs, PR outcomes, failure histories, discussion threads — before rendering a score. This is not a lightweight health check.
