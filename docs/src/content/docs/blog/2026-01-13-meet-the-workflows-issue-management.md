...
head:
  - tag: meta
    attrs:
      property: og:title
      content: "Meet the Workflows: Issue & PR Management"
  - tag: meta
    attrs:
      property: og:description
      content: "A curated tour of agentic workflows that enhance GitHub collaboration"
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      property: og:url
      content: https://github.github.com/gh-aw/blog/2026-01-13-meet-the-workflows-issue-management/
  - tag: meta
    attrs:
      name: twitter:card
