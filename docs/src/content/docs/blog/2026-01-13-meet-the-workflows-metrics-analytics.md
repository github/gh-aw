...
head:
  - tag: meta
    attrs:
      property: og:title
      content: "Meet the Workflows: Metrics & Analytics"
  - tag: meta
    attrs:
      property: og:description
      content: "A curated tour of metrics and analytics agentic workflows that turn data into insights"
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      property: og:url
      content: https://github.github.com/gh-aw/blog/2026-01-13-meet-the-workflows-metrics-analytics/
  - tag: meta
    attrs:
      name: twitter:card
