...
```bash
gh aw add https://github.com/github/gh-aw/blob/v0.40.0/.github/workflows/plan.md
```

**Discussion Task Miner:**

```bash
gh aw add https://github.com/github/gh-aw/blob/v0.40.0/.github/workflows/discussion-task-miner.md
```
