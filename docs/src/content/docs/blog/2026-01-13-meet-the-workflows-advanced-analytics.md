...
head:
  - tag: meta
    attrs:
      property: og:title
      content: "Meet the Workflows: Advanced Analytics & ML"
  - tag: meta
    attrs:
      property: og:description
      content: "A curated tour of agentic workflows that use ML to extract insights from agent behavior"
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      property: og:url
      content: https://github.github.com/gh-aw/blog/2026-01-13-meet-the-workflows-advanced-analytics/
  - tag: meta
    attrs:
      name: twitter:card
