...
hero:
  title: GitHub Agentic Workflows
  tagline: <strong>Automated repository agents running in GitHub Actions, safely and securely.</strong>
  actions:
...
GitHub Agentic Workflows deliver this: automated repository agents, running in GitHub Actions, with security-first design principles ensuring safe operation.
