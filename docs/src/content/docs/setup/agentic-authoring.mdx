...
2. Open VSCode Agent Chat or your Coding Agent and enter the following prompt:
   ...
   Then follow the instructions in .github/agents/agentic-workflows.agent.md to create a workflow.
...
3. If you haven't done so already, [set up your repository secrets](/gh-aw/reference/engines/) for the coding agent your workflow use (Copilot, Claude, Codex). Also adjust the `engine:` setting in your generated workflow to match if not using Copilot CLI.
