...
3. **Set up the required secret** - [`COPILOT_GITHUB_TOKEN`](/gh-aw/reference/authentication/#copilot_github_token), [`ANTHROPIC_API_KEY`](/gh-aw/reference/authentication/#anthropic_api_key) or [`OPENAI_API_KEY`](/gh-aw/reference/authentication/#openai_api_key).
...
> [!TIP]
> **Having trouble?** Check your [repository secrets](/gh-aw/reference/authentication/), see the [FAQ](/gh-aw/reference/faq/) and [Common Issues](/gh-aw/troubleshooting/common-issues/).
