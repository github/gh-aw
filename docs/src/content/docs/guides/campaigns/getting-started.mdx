...
banner:
  content: '<strong>Experimental:</strong> This feature is under active development and may change or behave unpredictably.'
---
...
The [Dependabot Burner workflow](https://github.com/github/gh-aw/blob/main/.github/workflows/dependabot-burner.md) is a small but useful campaign - it demonstrates the essential campaign pattern with minimal complexity:
