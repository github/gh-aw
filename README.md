...
[@MattSkala (6)](https://github.com/github/gh-aw/issues?q=is%3Aissue+is%3Aclosed+label%3Acommunity+author%3AMattSkala)
...
- **@pelikhan** for [#57520](https://github.com/github/gh-aw/issues/57520) "Recreate the Dreaming task router as a repository skill" — closed 2026-09-01, status: NOT_PLANNED
- **@silambarasan** for [#55516](https://github.com/github/gh-aw/issues/55516) "GH_AW_GITHUB_TOKEN secret not propagated to safeoutputs MCP container in agent job" — closed 2026-08-25, status: NOT_PLANNED
