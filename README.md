...
- **@pelikhan** for [Recreate the Dreaming task router as a repository skill](https://github.com/github/gh-aw/issues/57520) — closed 2026-09-01, no confirmed PR linkage found
- **@silambarasan** for [GH_AW_GITHUB_TOKEN secret not propagated to safeoutputs MCP container in agent job](https://github.com/github/gh-aw/issues/55516) — closed 2026-08-25, no confirmed PR linkage found
