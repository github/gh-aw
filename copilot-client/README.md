...
The build uses the TypeScript compiler (`tsc`) to transpile the TypeScript source into ESM JavaScript files targeting Node 24 (ES2024). The compiled output will be in the `dist/` directory:
