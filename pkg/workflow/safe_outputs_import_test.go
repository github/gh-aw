...
`
	...
	assert.False(t, *workflowData.SafeOutputs.ReportFailedJobs, "ReportFailedJobs should be imported as false")
...
`
	...
	assert.False(t, *workflowData.SafeOutputs.ReportFailedJobs, "ReportFailedJobs from main should take precedence")
