...
func (c *Compiler) validateCoreToolConfiguration(workflowData *WorkflowData, markdownPath string) error {
	validations := []struct {
		...
		{logMessage: "Validating tool profiles", validateFn: func() error { return validateCopilotToolProfile(workflowData) }},
...
func (c *Compiler) emitExperimentalFeatureWarningsTo(workflowData *WorkflowData, writer io.Writer) {
	...
	warnings := []struct {
		...
		{enabled: slices.Contains(workflowData.ToolProfiles, "go"), message: "Using experimental feature: tools.repository: go"},
	}
