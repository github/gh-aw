...
func addLogsCommandFlags(logsCmd *cobra.Command, validArtifactSets string) {
	...
	logsCmd.Flags().String("cached-json", "", "Path to previous logs JSON output to reuse for matching runs and periodically overwrite with current results")
