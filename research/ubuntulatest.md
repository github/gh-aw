...
> **Image updated to version 20260907.300.1** (September 2026). Key updates include: Go cached versions bumped to 1.24.13/1.25.14/1.26.8, Node.js cached versions bumped to 22.23.2/24.20.0, GitHub CLI updated to 2.100.0, Git unchanged at 2.55.0, Docker Client/Server unchanged at 28.0.4, Docker Buildx updated to 0.37.0, Podman downgraded to 4.9.3 (per announcement), Gradle updated to 9.7.1, Helm unchanged at 3.21.4, kubectl updated to 1.37.0, Kustomize updated to 5.8.1, Kind updated to 0.33.0, Minikube updated to 1.39.0, Pulumi updated to 3.261.0, AzCopy unchanged at 10.32.7, PHPUnit unchanged at 8.5.54, Java 25 bumped to 25.0.4+1. Also refreshed: AWS CLI 2.36.40, AWS SAM CLI 1.166.1, Azure CLI 2.90.0, Google Cloud CLI 583.0.0, Chrome/Chromium/Edge updated to 152.0.7977.x/152.0.4191.66, Firefox updated to 155.0, Geckodriver unchanged at 0.37.1, Selenium 4.48.0, Rust/Cargo/Rustup bumped to 1.98.1/1.98.1/1.29.1, GHC updated to 9.14.1. Announcements: PostgreSQL now available on Ubuntu Arm64 images; Podman will be downgraded on Ubuntu 22.04 and 24.04 runner images; Ubuntu 22 based runner images begin deprecation September 17th and will be fully unsupported by April 17th; Ubuntu 26.04 and Ubuntu 26.04 Arm now available as public preview.
...
- **Podman**: 4.9.3 (downgraded from 5.8.4 per GitHub announcement for Ubuntu 22.04/24.04 images)
- **Buildah**: 1.33.7
- **Skopeo**: 1.13.3
